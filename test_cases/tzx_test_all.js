/**
 * Test run a large number of TZX files
 */

const folders = [
  "/Users/dkThAhKo/Public/ZXTestData/WITH_ERRORS/TZX_with_errors",
...
const format = require("../public/main/formats/tzx_format");
...
const mylog = log.scope("tzx_test_all");
...
folders.forEach((folder) => {
  ...
  mylog.info(`********************************************************`);
  const count = helper.testRun(format.readTZX, folder, "tzx");
  totalFiles += count;
});
